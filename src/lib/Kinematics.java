...
import main.SuperFunAutoUtility;
...
public class Kinematics {
    ...
    public static Twist2d forwardKinematics(double left_wheel_delta, double right_wheel_delta) {
        double delta_rotation = (right_wheel_delta - left_wheel_delta) / (SuperFunAutoUtility.kDriveWheelTrackWidthInches * SuperFunAutoUtility.kTrackScrubFactor);
