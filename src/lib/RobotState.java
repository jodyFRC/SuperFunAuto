...
public class RobotState {
    ...
    public void outputToSmartDashboard() {
        ...
        System.out.println("Robot Pose X: " + odometry.getTranslation().x());
        System.out.println("Robot Pose Y: " + odometry.getTranslation().y());
        System.out.println("Robot Pose Theta: " + odometry.getRotation().getDegrees());
        System.out.println("Robot Linear Velocity: " + vehicle_velocity_measured_.dx);
        //System.out.println("Distance Driven: " + getDistanceDriven());
    }
}